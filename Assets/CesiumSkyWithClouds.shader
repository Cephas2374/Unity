...
Shader "Skybox/CesiumSkyWithClouds"
{
    Properties
    {
        ...
        _CloudCoverage ("Coverage",        Range(0, 1)) = 0.30
        _CloudSoftness ("Edge Softness",   Range(0.02, 0.6)) = 0.25
        _CloudSpeed    ("Wind Speed",      Range(0, 0.1)) = 0.006
        _CloudScale    ("Scale",           Range(2, 40)) = 6
        _CloudAltitude ("Altitude",        Range(0.1, 5.0)) = 1.5
        _CloudMinElev  ("Min Elevation",   Range(0.1, 0.8)) = 0.35
        _CloudOpacity  ("Max Opacity",     Range(0, 1)) = 0.85
